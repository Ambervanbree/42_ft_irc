...
# define RPL_INVITING(nick, channel, invitee)   "341 " + nick + " " + channel + " :Inviting " + invitee + " to " + channel + "\r\n"
...
# define KICK_message(nick, kicked, chan)				" KICK " + nick + " " + kicked + " " + chan + "\r\n"
# define KICK_message_2(nick, kicked, chan, reason)		" KICK " + nick + " " + kicked + " " + chan + " :" + reason + "\r\n"
